...
bot_token = os.environ.get("bot_token", "7662450309:AAEuDM2A0Pu0OL9EPP5kML8UlHXKZqPuvZk")
...
def start_buttons(bot, update):
    ...
    buttons = [[
        ...
        pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/the_my_first_robot?startchannel=true")
    ]]
